...
session_start() ;
	...
	$username = $_SESSION[ 'username' ] ;
		...
		echo "
				<html>
					<head> 
						<link rel = 'stylesheet' type = 'text/css' href = 'admin-issue.css'>
						...
						<div id = "record">
							...
							<div id = "book-record"> 
								<form id = "form-book-book" action = "admin-issue-mconf.php" method = "POST">
									...
									<input class = "hidden" id = "form-input-box" type = "text" name = "srno">
									<input id = "form-input-box" type = "text" name = "regno" placeholder = "Registration No." maxlength = 10 required>
									<input class = "hidden" id = "form-input-box" type = "text" name = "yer" placeholder = "Year of Admission" maxlength = 4>
									
									<hr>
									
									Book Details: </br></br>
									<input id = "form-input-box" type = "text" name = "bookid" placeholder = "Book ID" maxlength = 3 required>
