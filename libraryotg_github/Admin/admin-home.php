						...
						<div id = "record1">
							...
							<div id = "about"> 
								...
								<ul>
									...
									<li> Accession No. and Book ID of issued books.</li>
								</ul>
								...
								<form id = "form-book-book" action = "track-book-regno.php" method = "POST">
									<input id = "form-book-book-input" type = "text" name = "regno" placeholder = "Registration No." maxlength = 10 required>
									<input class = "hidden" id = "form-book-book-input" type = "text" name = "year" placeholder = "Year of Admission" maxlength = 4>
						...
						<div id = "record1">
							...
							<div id = "about"> 
								...
								<form id = "form-book-book" action = "track-book-stampno.php" method = "post">
									<input id = "form-book-book-input" type = "text" name = "stampno" placeholder = "Acc. No." maxlength = 5 required>
						...
						<div id = "record2" title = "Can also input only Year, or Year-Month to diversify search">
							...
							<div id = "about"> 
								<form id = "form-book-book" action = "track-book-issue.php" method = "post">
									<input id = "form-book-book-input" type = "text" name = "date" placeholder = "yyyy-mm-dd" maxlength = 10 required>
