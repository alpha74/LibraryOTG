<?php
	...
	$username = $_SESSION[ 'username' ] ;	
		...
		$q1_getno = "SELECT * FROM `issuedbooks` WHERE `issuedbooks`.`dateissue` LIKE '".$date."%' ; " ;
		...
		if( $zero_output > 0 )
		{		
			$q1_getrec = "SELECT * FROM `issuedbooks` WHERE `issuedbooks`.`dateissue` LIKE '".$date."%' ; " ;
		...
		echo "
				<html>
					<head> 
						<link rel = 'stylesheet' type = 'text/css' href = 'track-book-issue.css'>
