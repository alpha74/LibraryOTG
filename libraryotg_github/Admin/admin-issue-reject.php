...
<?php
	...
	// Query2 : Decrement book requests in studentuser_ : REMOVED : As no decrementing is needed in manual issue when there is some mismatch
	
		echo "
				<html>
					<head> 
						<link rel = 'stylesheet' type = 'text/css' href = 'admin-issue-reject.css'>
