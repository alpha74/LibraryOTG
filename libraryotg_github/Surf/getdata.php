<?php
	...
	else
	{
		...
		if( $query_filter == $all )
		{
			$query = "SELECT * FROM `bookdb` WHERE 1" ;
			$q2_getno = "SELECT * FROM `bookdb` WHERE 1" ;
			$filter_value = "All" ;
		}
		else
		{
						...
						<div id = 'box-left'>
							...
							<div id = 'box-left1'>
								...
								<div id = 'main-menu'>
									...
									<form action = 'surfer-records.php' method = 'POST'>
										<input id = 'button-tag-upper' type = 'submit' value = 'My Records'> 
									</form>
							...
							<div id = 'box-left2'>
								...
								<div id = 'filters-menu'>
									...
									<form action = 'getdata.php' method = 'POST'>
										...
										<input id = 'button-tag' type = 'submit' value = 'WebDev/Scripting'>
									</form>								
