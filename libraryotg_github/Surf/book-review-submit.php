...
<?php
	...
	$q2_inp = "INSERT INTO `book-review` (`srno`, `generator`, `gen_name`, `year`, `bookid`, `content`, `date`, `status`, `genuine`) VALUES (NULL, '".$generator."', '".$gen_name."','".$year."', '".$bookid."', '".$content."', '".$curr_date."','0', '1') ; " ; 
